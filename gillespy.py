...
class Model(object):
    ...
    def __init__(self,name="",volume = None):
        ...
        # It should be a logical error to leave this undefined, 
        # subclasses should set it.
        self.units = None
...
class gillespy_model(Model):
    """ gillespy_model has StochKit specific 
    serialization. """
...
class StochMLDocument():
    ...
    def from_model(cls,model):
        """ 
        Creates an StochKit XML document from an exisiting gillespy_model 
        object.
