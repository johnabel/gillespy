...
if __name__ == '__main__':
    ...
    tyson_model = gillespy.Model(name="tyson-2-state", volume=omega)
    ...
    tyson_model.add_parameter([P, kt, kd, a0, a1, a2, kdx])
    ...
    tyson_model.add_reaction([rxn1,rxn2,rxn3,rxn4,rxn5])

    # =============================================  
    # Simulate the mode and return the trajectories 
    # =============================================  
    tyson_trajectories = gillespy.simulate(tyson_model)
